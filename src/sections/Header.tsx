...
export const Header = () => {
  ...
  return <header className='border-b sticky top-0 border-white/15 z-10 px-2 py-4 md:border-none transition-all'>
    {/* Centered part */}
    <div className="container flex justify-between items-center md:border md:border-white/15 md:p-2.5 md:rounded-xl max-w-2xl mx-auto backdrop-blur">
