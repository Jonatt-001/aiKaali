...
export const Hero = () => {
  return <section className="h-[600px] lg:h-[650px] flex items-center relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_95%,transparent)] lg:-mt-10 overflow-x-hidden" style={{
